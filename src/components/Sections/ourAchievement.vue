<template>
  <section class="achievements pt-5 pb-5">
    <div class="container">
      <h1 class="text-center" style="color:white">Our Achievements</h1>
      <p class="text-center" style="color:#7d94a0">Numbers that tell our story of growth and success</p>
    </div>
    <div class="container">
      <div class="row">
